function index=alltrialstimecourse_newthor(headpath,fileexpnum,version,saveex,picknew,savefigs)
...
for k=1:5
    ...
    %ylim([-0.1144    0.5547]);
    yl=ylim;
    patch([10 10 20 20],[yl(1) yl(2) yl(2) yl(1)],[180/255 180/255 180/255],'FaceAlpha',0.2,'EdgeAlpha',0);
    patch([20 20 30 30],[yl(1) yl(2) yl(2) yl(1)],[0 0.6 230/255],'FaceAlpha',0.1,'EdgeAlpha',0);
    patch([30 30 40 40],[yl(1) yl(2) yl(2) yl(1)],[180/255 180/255 180/255],'FaceAlpha',0.2,'EdgeAlpha',0);
    title(directionnames{k});
    xlabel('t(s)');
    tracesub.XLim=[5 50];
    %xlim([0 45]);
